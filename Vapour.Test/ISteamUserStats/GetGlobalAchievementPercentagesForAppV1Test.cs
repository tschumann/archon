...
{
    public class GetGlobalAchivementPercentagesForAppV1Test : BaseControllerTest
    {
        public GetGlobalAchivementPercentagesForAppV1Test(WebApplicationFactory<Program> factory) : base(factory)
        {
        }
