...
{
    public class GetServerListTest : BaseControllerTest
    {
        public GetServerListTest(WebApplicationFactory<Program> factory) : base(factory)
        {
        }
        ...
        public async void TestGetServerListAuthenticated()
        {
            ...
            var responseString = await response.Content.ReadAsStringAsync();
            Assert.Equal("{\"response\":{\"servers\":[{\"address\":\"127.0.0.1:27015\",\"gameport\":27015,\"steamid\":\"123\",\"name\":\"Server\",\"appid\":50,\"gamedir\":\"gearbox\",\"version\":\"1.0.0.0\",\"product\":\"Half-Life: Opposing Force\",\"region\":255,\"players\":16,\"max_players\":32,\"bots\":0,\"map\":\"of\",\"secure\":true,\"dedicated\":true,\"os\":\"l\",\"gametype\":\"deathmatch\"},{\"address\":\"127.0.0.1:27015\",\"gameport\":27015,\"steamid\":\"123\",\"name\":\"Server\",\"appid\":70,\"gamedir\":\"valve\",\"version\":\"1.0.0.0\",\"product\":\"Half-Life\",\"region\":255,\"players\":16,\"max_players\":32,\"bots\":0,\"map\":\"map\",\"secure\":true,\"dedicated\":true,\"os\":\"l\",\"gametype\":\"deathmatch\"}]}}", responseString);
        }
